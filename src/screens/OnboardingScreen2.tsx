...
type Props = NativeStackNavigationProp<RootStack, "OnboardingScreen2">;
...
export default function OnboardingScreen2() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-50 dark:bg-black justify-center items-center px-6">
      ...
      >
        Intuitive design that makes chatting effortless
      </Animated.Text>

      {/* Illustration */}
      <Animated.View style={[illustrationStyle]} className="w-full h-64 mb-8">
        <Image
          source={require("../../assets/onboarding2.png")} // Replace with your asset
